...
INSERT INTO "new_SystemConfig" ("apiKey", "avgSceneDuration", "channelName", "createdAt", "defaultModelId", "defaultOutlinePrompt", "id", "minVideoDuration", "personaSettings", "updatedAt", "veo3Template") SELECT "apiKey", "avgSceneDuration", "channelName", "createdAt", "defaultModelId", "defaultOutlinePrompt", "id", "minVideoDuration", "personaSettings", "updatedAt", "veo3Template" FROM "SystemConfig";
